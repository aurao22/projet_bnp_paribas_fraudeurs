...
def train_model(model, model_name, 
    ...
    _ = predict_official_testset(model=model, test_origin=dataset_dict.get("test_origin", None), data_set_path=data_set_path, model_name=model_name, verbose=verbose)
...
def predict_official_testset(model, test_origin, data_set_path, model_name="", verbose=0):
